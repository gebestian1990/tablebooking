<%@ Page Title="" Language="C#" MasterPageFile="~/Restaurant/RestaurantMaster.Master" AutoEventWireup="true" CodeBehind="FoodCategory.aspx.cs" Inherits="tablebooking.Restaurant.FoodCategory" %>
            ...
            <div class="content-wrapper">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="forms-sample">
                                    ...
                                    <asp:Button ID="btnsubmit" runat="server" ValidationGroup="cat" CausesValidation="true" UseSubmitBehavior="false" Text="Submit" OnClientClick="if(!Page_ClientValidate('cat')){return false;}this.disabled=true;this.value='Submitting..';" OnClick="btnsubmit_Click" class="btn btn-primary me-2" />
                                    <asp:Button ID="btncancel" runat="server" class="btn btn-light" OnClick="btncancel_Click" Text="Cancel" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Food Category List</h4>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Sno.">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hfcid" Visible="false" runat="server" Value='<%#Eval("cid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Category">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblecategory" runat="server" Text='<%#Eval("fcategory") %>'></asp:Label>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="forms-sample">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Edit Food Category*</label>
                                        ...
                                        <asp:Button ID="btnupdate" runat="server" ValidationGroup="erdit" CausesValidation="true" UseSubmitBehavior="false" Text="Update" OnClick="btnupdate_Click" OnClientClick="if(!Page_ClientValidate('erdit')){return false;}this.disabled=true;this.value='Updateting..';" class="btn btn-primary me-2" />
